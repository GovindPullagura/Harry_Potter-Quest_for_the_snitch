  ...
  return (
    <div className="w-full flex justify-center h-screen bg-fixed bg-cover bg-no-repeat bg-[url('https://i.postimg.cc/Hx5BXvJG/hogwarts-castle-hd-harry-potter-and-the-chamber-of-secrets-1920x1080.jpg')]">
      ...
      >
        ...
        <div
          className={`bg-[url('https://i.postimg.cc/63wZZwkM/Quidditchpitch-1.webp')] bg-no-repeat  bg-[length:600px_800px]  w-[600px] h-[600px]  relative overflow-hidden  rounded-[10px]`}
        >
          {!isStart ? (
            <div
              className="relative rounded-full top-[49%]  bg-red-600 p-[10px] w-[150px] ml-[-50px] text-center text-[20px] text-white font-semibold left-1/2"
